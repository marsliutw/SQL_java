            ...
            public void onClick(View v) {
                if (ed_book.length()<1 || ed_price.length()<1)
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"新增失敗:"+e,Toast.LENGTH_LONG).show();
                    }
            }
        });
            ...
            public void onClick(View v) {
                if (ed_book.length()<1 || ed_price.length()<1)
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"更新失敗:"+e,Toast.LENGTH_LONG).show();
                    }
            }
        });
            ...
            public void onClick(View v) {
                if (ed_book.length()<1)
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this,"刪除失敗:"+e,Toast.LENGTH_LONG).show();
                    }
            }
        });
